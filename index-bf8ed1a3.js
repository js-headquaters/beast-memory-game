...
function GameOverComponent() {
  ...
  const [headerMessage] = h$1(getRandomCongratulation());
...
const statesComponents = /* @__PURE__ */ new Map([["init", GameFieldComponent], ["run", GameFieldComponent], ["game_over", GameOverComponent]]);
      ...
      children: o$1(ThemeContext.Provider, {
        ...
        children: o$1("div", {
          ...
          children: [o$1("div", {
            ...
            class: "game__content",
            children: [isMenuOpen.value ? o$1(StatisticComponent, {}) : o$1(StateComponent, {}), !isRunningInTelegram() && o$1("button", {
