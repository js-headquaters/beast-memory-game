...
const darkBackImage = "https://js-headquaters.github.io/beast-memory-game/back-dark-a5bcd3c7.jpg";

const lightBackImage = "https://js-headquaters.github.io/beast-memory-game/back-light-c1edf369.jpg";

const bearImage = "https://js-headquaters.github.io/beast-memory-game/bear-c55e6894.jpg";

const duckImage = "https://js-headquaters.github.io/beast-memory-game/duck-d06ea39e.jpg";
...
const foxImage = "https://js-headquaters.github.io/beast-memory-game/fox-6585f4c7.jpg";

const hedgehogImage = "https://js-headquaters.github.io/beast-memory-game/hedgehog-e27abbd5.jpg";
...
const owlImage = "https://js-headquaters.github.io/beast-memory-game/owl-48b001a3.jpg";

const pandaImage = "https://js-headquaters.github.io/beast-memory-game/panda-e0d3e3fc.jpg";

const pigImage = "https://js-headquaters.github.io/beast-memory-game/pig-9b1d2126.jpg";

const rabbitImage = "https://js-headquaters.github.io/beast-memory-game/rabbit-e9a4de30.jpg";

const sheepImage = "https://js-headquaters.github.io/beast-memory-game/sheep-25b90f5a.jpg";

const turtleImage = "https://js-headquaters.github.io/beast-memory-game/turtle-9854d7c8.jpg";

const cardImageMap = /* @__PURE__ */ new Map([["bear", bearImage], ["duck", duckImage], ["cat", catImage], ["chicken", chickenImage], ["dog", dogImage], ["fox", foxImage], ["hedgehog", hedgehogImage], ["lion", lionImage], ["monkey", monkeyImage], ["owl", owlImage], ["panda", pandaImage], ["pig", pigImage], ["rabbit", rabbitImage], ["sheep", sheepImage], ["turtle", turtleImage]]);
...
const animalCardTypes = ["bear", "owl", "cat", "chicken", "dog", "fox", "hedgehog", "lion", "monkey", "duck", "panda", "pig", "rabbit", "sheep", "turtle"];
...
class GameStateService {
  ...
  closeCards() {
    ...
    setTimeout(() => {
      ...
      if (!isCardMatched) {
        this.logger.log(`card "${firstCard.animalType}" do not match card "${secondCard.animalType}"`);
        return;
      }
