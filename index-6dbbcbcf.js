...
class GameMenuService {
  constructor() {
    this.isMenuOpen = a(false);
    this.isMenuButtonVisible = a(true);
...
class GameStateService {
  constructor(gameStatisticService, gameLevelService, gameMenuService) {
  ...
  setState(state) {
    if (state === "run") {
      ...
      const {
        horizontalCardsCount,
        pairsCount
      } = gameDifficultyMap.get(this.gameLevelService.gameLevel.value);
...
function GameComponent() {
  ...
  const showFallbackMenuButton = !isRunningInTelegram() && isMenuButtonVisible.value;
  return o$1(CombinedProvider, {
    gameStateService,
    ...
    children: o$1("div", {
      ...
      children: [o$1("div", {
        ...
        class: "game__content",
        children: [isMenuOpen.value ? o$1(GameMenuComponent, {}) : o$1(StateComponent, {}), showFallbackMenuButton && o$1("button", {
