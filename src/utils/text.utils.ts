...
const animalPhrases: Record<AnimalType, string> = {
  ...
  "chicken": "Cluck cluck! Thanks for matching me up! Now I can find my nest of psychedelic eggs!",
  ...
  "hedgehog": "Snuffle-snuffle! You've got a sharp mind, like my quills! Now I can find my favorite bugs!",
  "lion": "Roar! You've got the heart of a lion, helping me keep track of my pride!",
  "monkey": "Ee-ee! You're a barrel of fun! Now I won't forget where I hid my bananas!",
  "duck": "Quack-quack! You're just ducky! Thanks to you, I won't forget where my pond is!",
  "panda": "Munch-munch! Bamboo-zling work you did there, helping me find my bamboo forest!",
  "pig": "Oink-oink! You're hog-wild smart! Now I can find my mud bath!",
  "rabbit": "Hop-hop, hooray! Your memory's as fast as a rabbit! Now I won't forget where my carrots are!",
  "sheep": "Baa-baa! Ewe're aaa-absolutely ama-aaazing! Thanks to you-uu, I found my cozy pa-aaaasture!",
  "turtle": "Slow and steady wins the race, just like your memory! Now I can find my sunning rock!",
};
